...
##⚠️ EXPERIMENTAL FORK - DO NOT FLASH ⚠️

**The changes and firmware patches in this fork are experimental, unverified, and have not been safely tested on real hardware. Do not flash firmware generated by this fork to a scooter.**

Using experimental firmware may permanently brick the dashboard or motor controller and could cause unexpected or unsafe motor behaviour. For now, use this fork only for offline research, firmware analysis, and simulation. Real-hardware flashing should not be attempted until a tested recovery procedure and verified results are documented.
